...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(System.Action<Vox.Int3,byte>), factory.System_Action_Vox_Int3_byte);
		dict.Add(typeof(System.Action<Vox.Chunk>), factory.System_Action_Vox_Chunk);
		...
		DelegateTraits<System.Action<Vox.Int3,byte>>.Init(factory.System_Action_Vox_Int3_byte);
		DelegateTraits<System.Action<Vox.Chunk>>.Init(factory.System_Action_Vox_Chunk);
		...
		TypeTraits<System.Action<Vox.Int3,byte>>.Init(factory.Check_System_Action_Vox_Int3_byte);
		TypeTraits<System.Action<Vox.Chunk>>.Init(factory.Check_System_Action_Vox_Chunk);
		...
		StackTraits<System.Action<Vox.Int3,byte>>.Push = factory.Push_System_Action_Vox_Int3_byte;
		StackTraits<System.Action<Vox.Chunk>>.Push = factory.Push_System_Action_Vox_Chunk;
	...
	class System_Action_Vox_Int3_byte_Event : LuaDelegate
	{
		public System_Action_Vox_Int3_byte_Event(LuaFunction func) : base(func) { }
		public System_Action_Vox_Int3_byte_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(Vox.Int3 param0, byte param1)
		{
			func.BeginPCall();
		...
		public void CallWithSelf(Vox.Int3 param0, byte param1)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushValue(param0);
	...
	public System.Action<Vox.Int3,byte> System_Action_Vox_Int3_byte(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<Vox.Int3,byte> fn = delegate(Vox.Int3 param0, byte param1) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_Vox_Int3_byte_Event target = new System_Action_Vox_Int3_byte_Event(func);
			System.Action<Vox.Int3,byte> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_Vox_Int3_byte_Event target = new System_Action_Vox_Int3_byte_Event(func, self);
			System.Action<Vox.Int3,byte> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_Vox_Int3_byte(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<Vox.Int3,byte>), L, pos);
	}

	void Push_System_Action_Vox_Int3_byte(IntPtr L, System.Action<Vox.Int3,byte> o)
	{
		ToLua.Push(L, o);
	}

	class System_Action_Vox_Chunk_Event : LuaDelegate
	{
		public System_Action_Vox_Chunk_Event(LuaFunction func) : base(func) { }
		public System_Action_Vox_Chunk_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(Vox.Chunk param0)
		{
			func.BeginPCall();
		...
		public void CallWithSelf(Vox.Chunk param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public System.Action<Vox.Chunk> System_Action_Vox_Chunk(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<Vox.Chunk> fn = delegate(Vox.Chunk param0) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_Vox_Chunk_Event target = new System_Action_Vox_Chunk_Event(func);
			System.Action<Vox.Chunk> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_Vox_Chunk_Event target = new System_Action_Vox_Chunk_Event(func, self);
			System.Action<Vox.Chunk> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_Vox_Chunk(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<Vox.Chunk>), L, pos);
	}

	void Push_System_Action_Vox_Chunk(IntPtr L, System.Action<Vox.Chunk> o)
	{
		ToLua.Push(L, o);
	}
