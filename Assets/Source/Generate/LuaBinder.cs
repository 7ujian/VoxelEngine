...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.BeginModule("Vox");
		Vox_ChunkWrap.Register(L);
		Vox_VolumeWrap.Register(L);
		Vox_ChunkedVolumeWrap.Register(L);
		Vox_LargeVolumeWrap.Register(L);
		Vox_Int3Wrap.Register(L);
		Vox_BlockWrap.Register(L);
		Vox_BlockControllerWrap.Register(L);
		Vox_BlockUpdateTaskWrap.Register(L);
		L.EndModule();
		...
		L.RegFunction("Action_Vox_Int3_byte", System_Action_Vox_Int3_byte);
		L.RegFunction("Action_Vox_Chunk", System_Action_Vox_Chunk);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_Vox_Int3_byte(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Action<Vox.Int3,byte>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Action<Vox.Int3,byte>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_Vox_Chunk(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Action<Vox.Chunk>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Action<Vox.Chunk>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
